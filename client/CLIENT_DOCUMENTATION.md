...
| `AUTO_MATCH_DECLINED_NOTIFICATION` | `handleMatchDeclinedNotification()` | Show info | `GAME_MENU` |
...
| 0x59 | AUTO_MATCH_DECLINED_NOTIFICATION | `[len][game_id]` |
...
| WAITING_MATCH_START | AUTO_MATCH_DECLINED_NOTIFICATION | GAME_MENU | Show info |
